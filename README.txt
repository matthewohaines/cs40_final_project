Hanada Jusufovic, Allison Newman, Matthew Haines

To compile the code, enter the directory using cd <directoryName>
Type make
To run: ./simulation [input file] [intitial seed]

The most important design decision we had to make was involving Section class and Intersection class. Those two classes are at the center of the simulation. It made the most sense to make Intersection a child class of Section, because Intersection should contain all that Section contains, with a few additions and changes.

Another important design detail was the usage of linked lists to implement the lanes. Since lists are already linked, it was a good fit for the Sections and allowed a familiar interface to work with. 
