...
Another important design detail was the usage of vectors to implement the lanes. Since vectors are already linked, it was a good fit for the Sections and allowed a familiar interface to work with. 
